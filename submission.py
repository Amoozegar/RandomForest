...
class Data():
    ...
    def dataAllocation(self,path):
        ...
        df = pd.read_csv(path)
        y_data = df.loc[:,'y']
        x_data = df.iloc[:,0:(len(df.columns)-1)]
        # -------------------------------
...
class LinearRegressionModel():
    ...
    def lgTrainAccuracy(self,y_train,y_predict_train):
        ...
        y_predict_train = [1 if x>=0.5 else 0 for x in y_predict_train]
    ...
    def lgTestAccuracy(self,y_test,y_predict_test):
        ...
        y_predict_test = [1 if x>=0.5 else 0 for x in y_predict_test]
...
# Q3.3.2 Hyper-parameter Tuning
    ...
    def hyperParameterTuning(self,rf_clf,x_train,y_train):
        ...
        clf = GridSearchCV(rf_clf, param_grid=parameters)
...
# Q3.4.2 Classification
    ...
    def SVCClassifier(self,scaled_x_train,scaled_x_test, y_train):
        ...
        svm_clf.fit(scaled_x_train,y_train.values.ravel())
...
# Q3.4.3 Hyper-parameter Tuning
    ...
    def SVMBestScore(self, scaled_x_train, y_train):
        ...
        # ADD CODE HERE
        #n_jobs = -1 meaning all processsors in parallel
        clf = GridSearchCV(SVC(gamma = 'auto'),svm_parameters, return_train_score = True,n_jobs = -1 )
        svm_cv = clf.fit(scaled_x_train, y_train.values.ravel())
    ...
    def SVCClassifierParam(self,svm_cv,scaled_x_train,scaled_x_test,y_train):
        ...
        # -------------------------------
        # ADD CODE HERE
        clf = svm_cv.fit(scaled_x_train,y_train.values.ravel())
